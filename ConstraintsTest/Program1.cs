...
namespace InventorTest
{
    class Program
    {
        ...
        static string crossFile = FilePaths.crossFilePath;
        ...
        static Dictionary<string, Diameters> partLookup = generateLookupTable(FilePaths.faceAreasPath);
        static Dictionary<string, Diameters> tubingLookup = generateTubingLookupTable(FilePaths.tubingTablePath);
        static void Main(string[] args)
        {
            //Console.WriteLine(units.LengthUnits);
            //UpdatePipeDiameters("N_ID", "N_OD", 2, 2.1);
            //return;
            //Dictionary<string, Diameters> tubingLookup = generateTubingLookupTable($"{FilePaths.flange2Path}\\StandardPipeSizes.txt");
            ...
            string flange1File = $"{FilePaths.flange2Path}{selectedFlanges[0].Part}.ipt";
            string flange2File = $"{FilePaths.flange2Path}{selectedFlanges[1].Part}.ipt";
            string flange3File = $"{FilePaths.flange2Path}{selectedFlanges[2].Part}.ipt";
            string flange4File = $"{FilePaths.flange2Path}{selectedFlanges[3].Part}.ipt";
            string flange5File = $"{FilePaths.flange2Path}{selectedFlanges[4].Part}.ipt";
            string flange6File = $"{FilePaths.flange2Path}{selectedFlanges[5].Part}.ipt";
            ...
            {
                // Generate file path
                string flangeFile = $"{FilePaths.flangeStartPath}{(selectedFlanges[i].Part).ToString()}.ipt";
        ...
        static bool changeColorToGrey()
        {
            ...
            string blankCrossFile = $"{FilePaths.flange2Path}blankCross.ipt";
        ...
        static void AddConstraintsBetweenParts(ComponentOccurrence pipeOccurrence, ComponentOccurrence flangeOccurrence, string partNumber, in FlangeIdentifier oF, ObjectCollection fCollection)
        {
            ...
            UpdatePipeDiameters(ID_param, OD_param, tubeID, tubeOD);
